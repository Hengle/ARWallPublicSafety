...
public class EmailService  {
	...
	public void Send(string p_subject, string p_content, string[] p_targetEmails) {
		MailMessage mail = CreateMail("HelloPaul", "Thankful", _email, _name, p_targetEmails);
		SmtpClient smtp = CreateSMTP(_email, _password, _stmpAddress);

		// smtp.Send(mail);
	}

	private MailMessage CreateMail(string p_subject, string p_content, string p_email, string p_name, string[] p_targetEmails) {
